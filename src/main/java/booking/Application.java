...
import static movie_code.jes.elastic.Logging.logKafka;
import static movie_code.jes.util.Configuration.loadDefault;
import static movie_code.jes.util.Event.changed;
import static movie_code.jes.util.JsonFields.COMMAND;
import static movie_code.jes.util.JsonFields.ID;
import static movie_code.jes.util.Mongo.addNotDeleted;
import static movie_code.jes.util.Streams.start;
import static movie_code.mongo.JsonClient.aggregationPublisher;
import static movie_code.util.Collections.list;
import static movie_code.util.Util.tryToDoWithRethrow;
import static movie_code.util.Util.tryToGetSilent;
...
import movie_code.jes.Aggregate;
import movie_code.jes.Reactor;
import movie_code.jes.util.Streams;
